...
@section('content')
          <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="{{ route('dashboard.testmonial.update',$editdata->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-head">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $editdata->header }}" name="header" class="form-control">
                                </div>
                                <div class="form-group">
