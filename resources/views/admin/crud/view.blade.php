                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard.crud.search') }}" type="get">
                         ...
                         <div class="input-group justify-content-end">
                             ...
                             <form action="">
                                 <label for="">To:</label>
                                 <input type="time" name="submit" style="">
                             </form>
                             <form action="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @foreach ($data->crud_images as $images)
                                                <img src="/{{ $images->title }}" height="20" width="20"
                                                    alt="">
                                            @endforeach
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('dashboard.crud.edit', $data->id) }}"
                                                class="btn-btn-sm btn-success">edit</a>
                                            <a href="{{ route('dashboard.crud.delete', $data->id) }}"
